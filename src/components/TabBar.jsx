  ...
  return (
    <div className="tabbar" style={{display:"flex",background:C.white,borderTop:`1px solid ${C.grey}`,flexShrink:0}}>
      {tabs.map(([label,icon],i) => (
        <button key={i} style={{flex:1,background:"none",border:"none",borderTop:`3px solid ${tab===i?C.green:"transparent"}`,padding:"4px 2px 12px",display:"flex",flexDirection:"column",alignItems:"center",gap:3,cursor:"pointer",position:"relative"}} onClick={() => setTab(i)}>
